...
label remi_third_talk:
    ...
    show watta default at left
    play music "bgm_remi.mp3" fadein 1.0 
    r "Do you ever see a running car and wonder what it feels like to have your fingers crushed over by the wheels?"
    w "What?"
    r "Nevermind."
    r "I have this note with all of my past crimes wrote down."
    w "Wait what?"
    r "Yes I was kind of one, kinda... immature one."
    r "Do you really think, for the kinda bad bad crime, the ones that dont start from extreme poverty."
    r "Other than greed, do you think it's also because of jealousy."
    w "Huh?"
    r "I stopped doing them not because I stopped having jealousy, but because it's pretty boring doing so."
    r "I worked my status up, because when you are at the top of the world will there be nothing messing with your feeling anymore."
    r "So is jealousy, one of the 4 modern sins, if I believe nothing is above me, might it not tamper with my selfworth."
    r "Every time I watch someone doing some kind of skills, I reassure myself \"At least im better than them\" and that helps me defeat bad feelings."
    w "Don't you think that is a little arrogant?" 
    extend "Like looking down on everything?"
    r "Funny thing of course I dont want that, it's a self-treating remedy after all."
    w "What's wrong with being humble?"
    r "It works well, im not talking about lowering one's self, if you think about it doing that wont exactly help with jealousy."
    r "Jealousy is you wanting to be in the situation of something you think are getting what you wanted."
    r "Funny thing again you might be able to achieve it in some cases but you dont and just instead stand there and be jealous."
    w "What's the point you trying to make man?"
    r "This is what caused me fear trying to get back."
    r "My jealousy won't let me enjoy peace as my inner self keeps trying to fuel me up my rage bar."
    r "I will do break bad again. And again. Perpetual cycle of madness."
    w "It's okay Remi, we all do feel like that, it's just..."
    w "You need to share out your feeling man. And then we will start working with it over time."
    w "Changes don't expect to be sudden."
    r "You say calmly like that but would you still be when i ramble about the same problem for the hundredths of times."
    w "People know you well Remi they can totally tolerate you better than when you are hiding away from them."
    w "You are smart Remi you can learn. You can totally adapt after a while."
    r "..."
    r "..."
    r "I don't wanna live like this"
    r "Fine I will, just, give me some times."
    ...
    $ item_add("Crime Note")
    r "I want to dispose of my past, and also I think you should be aware of it, I don't wanna be so secure about myself anymore."
    r "Just dont... share it with anyone."
    w "Alright"
    r "Meet me at the beach tomorrow I will let you in the lighthouse."
