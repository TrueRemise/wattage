...
define unknown = Character("???", color="#000000", what_size=50, what_ypos = 15, what_xpos =340, callback=unknown_talk_callback)
define w = Character("Watta", what_font="fonts/Watta.ttf",who_font="fonts/Watta.ttf", size = 50, what_size=50, what_xpos =350, color="#fcba03", callback=w_talk_callback)
define r = Character("Remi", what_font="fonts/Remi.ttf", who_font="fonts/Remi.ttf", size = 55, who_xpos = 10, who_ypos = 30, what_size=50, what_ypos = 15, what_xpos =350, color="#656565", callback=r_talk_callback)
define sr = Character("Sari", what_font="fonts/Sari.ttf", who_font="fonts/Sari.ttf", size = 55, who_xpos = 20, who_ypos = 30, what_size=55, color="#1cb8c6", callback=sr_talk_callback)
define lan = Character("Flan", what_font="fonts/Lan.ttf", who_font="fonts/Lan.ttf", size = 55, who_xpos = 15, who_ypos = 29, what_size=47, what_ypos = 0, what_xpos =350, color="#583ddd", callback=lan_talk_callback)
define c = Character("Chii", what_font="fonts/Chiko.ttf", who_font="fonts/Chiko.ttf", size = 75, who_xpos = 10, who_ypos = 25, what_size=75, what_ypos = -5, what_xpos =350, color="#4dc31f", callback=c_talk_callback)
define n = Character("Nemu", what_font="fonts/Nemu.ttf", who_font="fonts/Nemu.ttf", size = 55, who_xpos = 10, who_ypos = 25, what_size=55, what_ypos = 5, what_xpos =350, color="#8c8c8c", callback=n_talk_callback)
define ts = Character("Tsuyu", what_font="fonts/Tsuyu.ttf", who_font="fonts/Tsuyu.ttf", size = 48, who_xpos = 10, who_ypos = 20, what_size=45, what_ypos = -20, what_xpos =340, color="#ddba21", callback=ts_talk_callback)
define iog = Character("Iog", what_font="fonts/Iog.ttf", who_font="fonts/Iog.ttf", size = 45, who_xpos = 12, who_ypos = 25, color="#000000", callback=iog_talk_callback)
define john = Character("John", what_font="fonts/Iog.ttf", who_font="fonts/Terraria.ttf", size = 45, who_xpos = 12, who_ypos = 25, color="#000000", callback=john_talk_callback)
define rn = Character("Renia", what_font="fonts/Reni.ttf", who_font="fonts/Reni.ttf", size = 48, who_xpos = 25, who_ypos = 24, what_size=55, what_ypos = -0, what_xpos =350, color="#f94886", callback=rn_talk_callback)
define nk = Character("Neko", what_font="fonts/Reni.ttf", who_font="fonts/Reni.ttf", size = 48, who_xpos = 25, who_ypos = 24, what_size=55, what_ypos = -0, what_xpos =350, color="#f49e4d", callback=nk_talk_callback)
define sc = Character("Sanco", what_font="fonts/Sanco.ttf", who_font="fonts/Sanco.ttf", size = 55, who_xpos = 10, who_ypos = 25, what_size=55, what_ypos = -11, what_xpos =350, color="#c6892d", callback=sc_talk_callback)
define tt = Character("Tato", what_font="fonts/Tato.ttf", who_font="fonts/Tato.ttf", size = 74, who_xpos = 25, who_ypos = 27, what_size=75, what_ypos = -0, what_xpos =350, color="#48ca37", callback=tt_talk_callback)
define kr = Character("Kuro", what_font="fonts/Kuro.ttf", who_font="fonts/Kuro.ttf", size = 65, who_xpos = 10, who_ypos = 25, what_size=65, what_ypos = -11, what_xpos =350, color="#c62d2d", callback=kr_talk_callback)
define wo = Character("Woogie", what_font="fonts/Woogie.ttf", who_font="fonts/Woogie.ttf", size = 45, who_xpos = -5, who_ypos = 25, what_size=45, what_ypos = 15, what_xpos =350, color="#2db4c6", callback=wo_talk_callback)
define tk = Character("Toko", what_font="fonts/Toko.ttf", who_font="fonts/Toko.ttf", size =60, who_xpos = 13, who_ypos = 30, what_size=55, what_ypos = 10, what_xpos =380, color="#c7c757", callback=tk_talk_callback)
define ik = Character("Iskra", what_font="fonts/Iskra.ttf", who_font="fonts/Iskra.ttf", size = 85, who_xpos = -5, who_ypos = 25, what_size=45, what_ypos = 15, what_xpos =380, color="#c770b8", callback=ik_talk_callback)
define b = Character("Bailey", what_font="fonts/Bailey.ttf", who_font="fonts/Bailey.ttf", size = 75, who_xpos = 0, who_ypos = 25, what_size=65, what_ypos = 10, what_xpos =350, color="#57bcc7", callback=b_talk_callback)
define o = Character("Owl", what_font="fonts/Owl.ttf", who_font="fonts/Owl.ttf", size = 55, who_xpos = 15, who_ypos = 35, what_size=40, what_ypos = 25, what_xpos =355, color="#908c53", callback=o_talk_callback)
define tkn = Character("Tsukino", what_font="fonts/Tsukino.ttf", who_font="fonts/Tsukino.ttf", size = 45, who_xpos = -10, who_ypos = 30, what_size=45, what_ypos = 10, what_xpos =350, color="#a75028", callback=tkn_talk_callback)
define sn = Character("Snowie", what_font="fonts/Snowie.ttf", who_font="fonts/Snowie.ttf", size = 50, who_xpos = -10, who_ypos = 25, what_size=50, what_ypos = 15, what_xpos =340, color="#212d7b", callback=sn_talk_callback)
define vv = Character("Vivi", what_font="fonts/Vivi.ttf", who_font="fonts/Vivi.ttf", size = 65, who_xpos = 5, who_ypos = 35, what_size=50, what_ypos = 15, what_xpos =340, color="#23899d", callback=vv_talk_callback)
define al = Character("Aloy", what_font="fonts/Aloy.ttf", who_font="fonts/Aloy.ttf", size = 45, who_xpos = 10, who_ypos = 30, what_size=38, what_ypos = 15, what_xpos =340, color="#8a1313", callback=al_talk_callback)
define dv = Character("Moff", what_font="fonts/Moff.ttf", who_font="fonts/Moff.ttf", size = 45, who_xpos = 10, who_ypos = 30, what_size=38, what_ypos = 15, what_xpos =340, color="#a87f1a", callback=dv_talk_callback)
define mk = Character("Mokka", what_font="fonts/Mokka.ttf", who_font="fonts/Mokka.ttf", size = 45, who_xpos = 10, who_ypos = 30, what_size=38, what_ypos = 15, what_xpos =340, color="#8a3713", callback=mk_talk_callback)
